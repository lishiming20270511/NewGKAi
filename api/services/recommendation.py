...
_MAJOR_EXCLUDED_SPECIALTIES: dict[str, list[str]] = {
    # IT/工科/理学：排除明显无工科的专业性院校
    "计算机":   ["艺术类", "体育类", "政法类", "中医药类", "外语类", "农林类"],
    "软件工程": ["艺术类", "体育类", "政法类", "中医药类", "外语类", "农林类"],
    "人工智能": ["艺术类", "体育类", "政法类", "中医药类", "外语类", "农林类"],
    "数据科学": ["艺术类", "体育类", "政法类", "中医药类", "外语类", "农林类"],
    "电子信息": ["艺术类", "体育类", "政法类", "中医药类", "外语类", "农林类"],
    "通信工程": ["艺术类", "体育类", "政法类", "中医药类", "外语类", "农林类"],
    "电气工程": ["艺术类", "体育类", "政法类", "中医药类", "外语类", "农林类"],
    "自动化":   ["艺术类", "体育类", "政法类", "中医药类", "外语类", "农林类"],
    "机械工程": ["艺术类", "体育类", "政法类", "中医药类", "外语类", "农林类"],
    "土木工程": ["艺术类", "体育类", "政法类", "中医药类", "外语类"],
    "建筑学":   ["艺术类", "体育类", "政法类", "中医药类", "外语类"],
    "数学":     ["艺术类", "体育类", "政法类", "中医药类", "外语类"],
    "物理学":   ["艺术类", "体育类", "政法类", "中医药类", "外语类"],
